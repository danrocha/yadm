...
# or set a custom fsormat using the strftime function format specifications,
...
plugins=(git zsh-autosuggestions docker npm macos fzf z)
...
# allow NPM to install globally without sudo
